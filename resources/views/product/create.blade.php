...
@endpush
@section('content')
    <div class="container" id="new-product-container">
        <h1 id="page-title">Add Product</h1>
        <form action="/products" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}

            <div class="row">
                <div id="new-product-image" class="col-sm-12 col-md-7 col-lg-7 col-xl-7">
                ...
                <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sizes" id="sizes" aria-describedby="emailHelp" placeholder="Eg:10,5.5,6" required>
                    ...
                    <button type="submit" title="Submit" class="btn btn-primary">Add Product</button>
